package net.mcreator.pifase.entity.renderer;
...
import net.mcreator.pifase.entity.OctoturtEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class OctoturtRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(OctoturtEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelalex(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("pifase:textures/octoturt.png");
					}
				};
			});
		}
