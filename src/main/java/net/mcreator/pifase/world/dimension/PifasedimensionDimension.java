...
package net.mcreator.pifase.world.dimension;
...
import net.mcreator.pifase.item.PifasedimensionItem;
import net.mcreator.pifase.block.PifaseBlockBlock;
import net.mcreator.pifase.PifaseModElements;
...
@PifaseModElements.ModElement.Tag
public class PifasedimensionDimension extends PifaseModElements.ModElement {
	@ObjectHolder("pifase:pifasedimension_portal")
	public static final CustomPortalBlock portal = null;
	public PifasedimensionDimension(PifaseModElements instance) {
		super(instance, 4);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(PifaseBlockBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("pifase:pifasedimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("pifasedimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("pifasedimension_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("pifasedimension_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new PifasedimensionItem().setRegistryName("pifasedimension"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("pifasedimension_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("pifase:pifasedimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("pifase:pifasedimension")));
				} else {
					entity.func_242279_ag();
	...
	public static class CustomPortalSize {
		private static final AbstractBlock.IPositionPredicate POSITION_PREDICATE = (state, blockReader, pos) -> {
			return state.getBlock() == Blocks.EMERALD_BLOCK.getDefaultState().getBlock();
		};
					...
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0
									? Blocks.EMERALD_BLOCK.getDefaultState().getBlock().getDefaultState()
									: Blocks.AIR.getDefaultState();
